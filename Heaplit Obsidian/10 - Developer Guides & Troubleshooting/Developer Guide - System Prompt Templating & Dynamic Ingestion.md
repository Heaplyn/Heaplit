...
InstructionsManager prompt loading, custom user rules, dynamic system prompt override injection. This developer guide provides complete technical documentation, architectural standards, code snippets, and troubleshooting routines for Heaplit developers.
...
namespace Heaplit.Core.Guides
{
    public sealed class SystemPromptTemplating&DynamicIngestionEngine
    {
        ...
        public async Task ExecuteOperationAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                Console.WriteLine("[HEAPLIT DEV GUIDE] Executing operation for 📜 Developer Guide - System Prompt Templating & Dynamic Ingestion");
