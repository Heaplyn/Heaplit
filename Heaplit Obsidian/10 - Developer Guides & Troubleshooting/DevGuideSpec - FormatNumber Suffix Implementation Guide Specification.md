...
This specification provides complete architectural, structural, and operational details for **FormatNumber Suffix Implementation Guide** within the Heaplit System.
...
namespace Heaplit.Core.Subsystems.DevGuideSpec
{
    public sealed class FormatNumberSuffixImplementationGuideManager : IAsyncDisposable
    {
        ...
        public async Task<bool> ExecuteFormatNumberSuffixImplementationGuideAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                Console.WriteLine("[HEAPLIT DEVGUIDESPEC] Executing FormatNumber Suffix Implementation Guide operation...");
                ...
                if (NativeMethods.GetSystemTimes(out FILETIME idle, out FILETIME kernel, out FILETIME user))
                {
                    ...
                    if (totalSys > 0)
                    {
                        Console.WriteLine($"[HEAPLIT DEVGUIDESPEC] System Ticks Active: {totalSys}");
                    }
                }
