...
This specification provides complete architectural, structural, and operational details for **Visual Studio App Crash Debugging** within the Heaplit System.
...
namespace Heaplit.Core.Subsystems.DevGuideSpec
{
    public sealed class VisualStudioAppCrashDebuggingManager : IAsyncDisposable
    {
        ...
        public async Task<bool> ExecuteVisualStudioAppCrashDebuggingAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                Console.WriteLine("[HEAPLIT DEVGUIDESPEC] Executing Visual Studio App Crash Debugging operation...");
