...
This specification provides complete architectural, structural, and operational details for **psapi EmptyWorkingSet Native Marshaller** within the Heaplit System.
...
namespace Heaplit.Core.Subsystems.OptEngineSpec
{
    public sealed class psapiEmptyWorkingSetNativeMarshallerManager : IAsyncDisposable
    {
        ...
        public async Task<bool> ExecutepsapiEmptyWorkingSetNativeMarshallerAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                Console.WriteLine("[HEAPLIT OPTENGINESPEC] Executing psapi EmptyWorkingSet Native Marshaller operation...");
