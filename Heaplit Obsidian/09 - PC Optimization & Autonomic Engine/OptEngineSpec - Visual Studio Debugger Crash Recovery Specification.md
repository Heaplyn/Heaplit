...
This specification provides complete architectural, structural, and operational details for **Visual Studio Debugger Crash Recovery** within the Heaplit System.
...
namespace Heaplit.Core.Subsystems.OptEngineSpec
{
    public sealed class VisualStudioDebuggerCrashRecoveryManager : IAsyncDisposable
    {
        ...
        public async Task<bool> ExecuteVisualStudioDebuggerCrashRecoveryAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                Console.WriteLine("[HEAPLIT OPTENGINESPEC] Executing Visual Studio Debugger Crash Recovery operation...");
