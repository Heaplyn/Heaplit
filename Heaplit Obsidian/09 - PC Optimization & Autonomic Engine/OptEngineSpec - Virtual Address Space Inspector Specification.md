...
This specification provides complete architectural, structural, and operational details for **Virtual Address Space Inspector** within the Heaplit System.
...
namespace Heaplit.Core.Subsystems.OptEngineSpec
{
    public sealed class VirtualAddressSpaceInspectorManager : IAsyncDisposable
    {
        ...
        public async Task<bool> ExecuteVirtualAddressSpaceInspectorAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                Console.WriteLine("[HEAPLIT OPTENGINESPEC] Executing Virtual Address Space Inspector operation...");
