...
This specification provides complete architectural, structural, and operational details for **GC Compacting Heap Optimizer** within the Heaplit System.
...
namespace Heaplit.Core.Subsystems.OptEngineSpec
{
    public sealed class GCCompactingHeapOptimizerManager : IAsyncDisposable
    {
        ...
        public async Task<bool> ExecuteGCCompactingHeapOptimizerAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                Console.WriteLine("[HEAPLIT OPTENGINESPEC] Executing GC Compacting Heap Optimizer operation...");
