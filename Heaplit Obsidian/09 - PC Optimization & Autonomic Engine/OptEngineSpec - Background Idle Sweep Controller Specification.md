...
This specification provides complete architectural, structural, and operational details for **Background Idle Sweep Controller** within the Heaplit System.
...
namespace Heaplit.Core.Subsystems.OptEngineSpec
{
    public sealed class BackgroundIdleSweepControllerManager : IAsyncDisposable
    {
        ...
        public async Task<bool> ExecuteBackgroundIdleSweepControllerAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                Console.WriteLine("[HEAPLIT OPTENGINESPEC] Executing Background Idle Sweep Controller operation...");
