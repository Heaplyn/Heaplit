...
This specification provides complete architectural, structural, and operational details for **System Idle Time Calculator** within the Heaplit System.
...
namespace Heaplit.Core.Subsystems.OptEngineSpec
{
    public sealed class SystemIdleTimeCalculatorManager : IAsyncDisposable
    {
        ...
        public async Task<bool> ExecuteSystemIdleTimeCalculatorAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                Console.WriteLine("[HEAPLIT OPTENGINESPEC] Executing System Idle Time Calculator operation...");
