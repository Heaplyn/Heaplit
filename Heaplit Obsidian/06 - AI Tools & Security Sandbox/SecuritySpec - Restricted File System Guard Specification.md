...
This specification provides complete architectural, structural, and operational details for **Restricted File System Guard** within the Heaplit System.
...
namespace Heaplit.Core.Subsystems.SecuritySpec
{
    public sealed class RestrictedFileSystemGuardManager : IAsyncDisposable
    {
        ...
        public async Task<bool> ExecuteRestrictedFileSystemGuardAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                Console.WriteLine("[HEAPLIT SECURITYSPEC] Executing Restricted File System Guard operation...");
