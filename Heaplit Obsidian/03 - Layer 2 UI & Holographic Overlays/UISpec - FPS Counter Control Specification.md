...
This specification provides complete architectural, structural, and operational details for **FPS Counter Control** within the Heaplit System.
...
namespace Heaplit.Core.Subsystems.UISpec
{
    public sealed class FPSCounterControlManager : IAsyncDisposable
    {
        ...
        public async Task<bool> ExecuteFPSCounterControlAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                Console.WriteLine("[HEAPLIT UISPEC] Executing FPS Counter Control operation...");
