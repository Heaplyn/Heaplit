...
This specification provides complete architectural, structural, and operational details for **PhysicsService Collision Group Manager** within the Heaplit System.
...
namespace Heaplit.Core.Subsystems.RobloxSpec
{
    public sealed class PhysicsServiceCollisionGroupManagerManager : IAsyncDisposable
    {
        ...
        public async Task<bool> ExecutePhysicsServiceCollisionGroupManagerAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                Console.WriteLine("[HEAPLIT ROBLOXSPEC] Executing PhysicsService Collision Group Manager operation...");
