...
This specification provides complete architectural, structural, and operational details for **Studio Place Instance Graph Inspector** within the Heaplit System.
...
namespace Heaplit.Core.Subsystems.RobloxSpec
{
    public sealed class StudioPlaceInstanceGraphInspectorManager : IAsyncDisposable
    {
        ...
        public async Task<bool> ExecuteStudioPlaceInstanceGraphInspectorAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                Console.WriteLine("[HEAPLIT ROBLOXSPEC] Executing Studio Place Instance Graph Inspector operation...");
