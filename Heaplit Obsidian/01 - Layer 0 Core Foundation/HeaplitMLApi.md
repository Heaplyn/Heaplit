---
title: "HeaplitMLApi - Technical Specification"
...
# HeaplitMLApi - Technical Specification

> [!NOTE] Subsystem Architectural Blueprint & Developer Reference
> **Source File**: `Modules\Layer0\Common\HeaplitMLApi.cs`  
...
Heaplit Native C# ML API.
          Exposes Godellian Brain and Layered Tensor operations to external components.

`HeaplitMLApi` is an integral part of `01 - Layer 0 Core Foundation`. It enforces the Heaplit architectural invariant where lower layers provide isolated, crash-proof services to higher-level UI and command execution layers.

---

## ⚙️ Practical Real-World Workflow & Developer Use Cases
Executes core operational logic for `HeaplitMLApi` within the `01 - Layer 0 Core Foundation` subsystem. It provides asynchronous processing, memory-safe data operations, and direct integration with the Heaplit desktop assistant.
...
// Developer: heaplyn
// Date: 2026-08-18
// Summary: Heaplit Native C# ML API.
//          Exposes Godellian Brain and Layered Tensor operations to external components.
...
namespace HeaplitLauncher
{
    public static class HeaplitMLApi
    {
        // ── TEXT & LLM ──────────────────────────────────────────────────────────
...
sequenceDiagram
    ...
    participant Sub as HeaplitMLApi
