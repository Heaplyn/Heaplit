...
Heaplit maintains persistent knowledge across sessions through an autonomous background sync engine that bridges the launcher with external AI coding environments (Cursor, Windsurf, VS Code, Cline, Roo-Code).
...
| `Data/Instructions/Evolved_Laws.md` | On user correction | Learned heuristics (e.g. *"Always use Ring 0 utilities for formatting in Heaplit"*). |
