...
This specification provides complete architectural, structural, and operational details for **Process Lifecycles** within the Heaplit System.
...
namespace Heaplit.Core.Subsystems.ArchSpec
{
    public sealed class ProcessLifecyclesManager : IAsyncDisposable
    {
        ...
        public async Task<bool> ExecuteProcessLifecyclesAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                Console.WriteLine("[HEAPLIT ARCHSPEC] Executing Process Lifecycles operation...");
