...
This specification provides complete architectural, structural, and operational details for **PowerShell Executor Sandbox** within the Heaplit System.
...
namespace Heaplit.Core.Subsystems.ArchSpec
{
    public sealed class PowerShellExecutorSandboxManager : IAsyncDisposable
    {
        ...
        public async Task<bool> ExecutePowerShellExecutorSandboxAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                Console.WriteLine("[HEAPLIT ARCHSPEC] Executing PowerShell Executor Sandbox operation...");
