...
This specification provides complete architectural, structural, and operational details for **Working Set Trimming Policy** within the Heaplit System.
...
namespace Heaplit.Core.Subsystems.ArchSpec
{
    public sealed class WorkingSetTrimmingPolicyManager : IAsyncDisposable
    {
        ...
        public async Task<bool> ExecuteWorkingSetTrimmingPolicyAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                Console.WriteLine("[HEAPLIT ARCHSPEC] Executing Working Set Trimming Policy operation...");
