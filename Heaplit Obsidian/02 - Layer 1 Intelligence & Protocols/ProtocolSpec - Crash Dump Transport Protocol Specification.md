...
This specification provides complete architectural, structural, and operational details for **Crash Dump Transport Protocol** within the Heaplit System.
...
namespace Heaplit.Core.Subsystems.ProtocolSpec
{
    public sealed class CrashDumpTransportProtocolManager : IAsyncDisposable
    {
        ...
        public async Task<bool> ExecuteCrashDumpTransportProtocolAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                Console.WriteLine("[HEAPLIT PROTOCOLSPEC] Executing Crash Dump Transport Protocol operation...");
