...
This specification provides complete architectural, structural, and operational details for **Prompt Injection Guard** within the Heaplit System.
...
namespace Heaplit.Core.Subsystems.AgentSpec
{
    public sealed class PromptInjectionGuardManager : IAsyncDisposable
    {
        ...
        public async Task<bool> ExecutePromptInjectionGuardAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                Console.WriteLine("[HEAPLIT AGENTSPEC] Executing Prompt Injection Guard operation...");
