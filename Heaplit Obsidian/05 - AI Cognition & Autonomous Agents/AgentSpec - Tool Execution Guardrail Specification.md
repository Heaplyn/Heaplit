...
This specification provides complete architectural, structural, and operational details for **Tool Execution Guardrail** within the Heaplit System.
...
namespace Heaplit.Core.Subsystems.AgentSpec
{
    public sealed class ToolExecutionGuardrailManager : IAsyncDisposable
    {
        ...
        public async Task<bool> ExecuteToolExecutionGuardrailAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                Console.WriteLine("[HEAPLIT AGENTSPEC] Executing Tool Execution Guardrail operation...");
