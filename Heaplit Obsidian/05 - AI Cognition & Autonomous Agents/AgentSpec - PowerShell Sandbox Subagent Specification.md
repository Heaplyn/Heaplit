...
This specification provides complete architectural, structural, and operational details for **PowerShell Sandbox Subagent** within the Heaplit System.
...
namespace Heaplit.Core.Subsystems.AgentSpec
{
    public sealed class PowerShellSandboxSubagentManager : IAsyncDisposable
    {
        ...
        public async Task<bool> ExecutePowerShellSandboxSubagentAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                Console.WriteLine("[HEAPLIT AGENTSPEC] Executing PowerShell Sandbox Subagent operation...");
