...
This specification provides complete architectural, structural, and operational details for **JSON Schema Validator** within the Heaplit System.
...
namespace Heaplit.Core.Subsystems.AgentSpec
{
    public sealed class JSONSchemaValidatorManager : IAsyncDisposable
    {
        ...
        public async Task<bool> ExecuteJSONSchemaValidatorAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                Console.WriteLine("[HEAPLIT AGENTSPEC] Executing JSON Schema Validator operation...");
