...
This specification provides complete architectural, structural, and operational details for **Object Manager Directory Inspector** within the Heaplit System.
...
namespace Heaplit.Core.Subsystems.RevEngSpec
{
    public sealed class ObjectManagerDirectoryInspectorManager : IAsyncDisposable
    {
        ...
        public async Task<bool> ExecuteObjectManagerDirectoryInspectorAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                Console.WriteLine("[HEAPLIT REVENGSPEC] Executing Object Manager Directory Inspector operation...");
